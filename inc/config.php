...
$one                               = new Template('OneUI', '3.3', 'https://www.mycheapremovals.co.uk/system/assets'); // Name, version and assets folder's name
...
$one->main_nav                     = array(
    array(
        'name'  => '<span class="sidebar-mini-hide">Create Quote</span>',
        'icon'  => 'si si-speedometer',
        'url'   => '/system/create_quote/'
    ),

    array(
        'name'  => '<span class="sidebar-mini-hide">Quotes </span>',
        'icon'  => 'si si-speedometer',
        'url'   => '/system/quotes/'
    ),

    array(
        'name'  => '<span class="sidebar-mini-hide">Deposit paid</span>',
        'icon'  => 'si si-wallet',
        'url'   => '/system/paid_quotes/'
    ),

    array(
        'name'  => '<span class="sidebar-mini-hide">In transit</span>',
        'icon'  => 'si si-rocket',
        'url'   => '/system/in_transit/'
    ),

    array(
        'name'  => '<span class="sidebar-mini-hide">All done</span>',
        'icon'  => 'si si-like',
        'url'   => '/system/all_done/'
    ),
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Config</span>',
        'icon'  => 'si si-rocket',
        'url'   => '/system/config/'
    )
//    array(
